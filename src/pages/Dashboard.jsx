...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState('claims'); // Track active main tab
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Manage claims and conference room bookings
            </p>
          </div>
          {activeTab === 'claims' && (
        ...
        {/* Main Content - Claims by default, with optional Conference Rooms tab */}
        {canViewRoomAnalytics ? (
          <Tabs defaultValue="claims" value={activeTab} onValueChange={setActiveTab} className="mb-6">
            ...
            <TabsContent value="rooms">
              <div className="space-y-6">
                <CalendarViewWidget userRole={userRole} user={user} defaultExpanded={true} />
                <RoomAnalyticsWidget />
              </div>
            </TabsContent>
          </Tabs>
